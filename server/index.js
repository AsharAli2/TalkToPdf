...
const ai = new GoogleGenAI({ apiKey: "AIzaSyDYwaU7O_BQRcidaITAxTg2fKJf1W8kejg" });
...
app.get('/check-collection', async (req, res) => {
    ...
    const QDRANT_URL = 'https://3a914622-18d9-4522-abb1-8916ba6870e7.us-east4-0.gcp.cloud.qdrant.io:6333';
    const QDRANT_API_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhY2Nlc3MiOiJtIn0._7qOZ0JtgfQyYcvEy8cvrMFFZARTBwyDIqYv9PCJqS8';
